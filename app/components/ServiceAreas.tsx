    ...
    <section id="areas" className="py-24 bg-brand-dark overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 gap-16 items-center">
          {/* Left */}
          <div>
            <span className="inline-block text-brand-red text-sm font-semibold uppercase tracking-widest mb-3">Coverage</span>
          ...
          <div className="mt-10 lg:mt-0">
            <div className="flex flex-wrap gap-3">
              {areas.map((area) => (
                ...
                >
                  <svg className={`w-3.5 h-3.5 ${area === "Toronto" ? "text-white" : "text-brand-red"}`} fill="currentColor" viewBox="0 0 20 20">
