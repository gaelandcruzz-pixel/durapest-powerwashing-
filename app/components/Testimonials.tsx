const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    text: "I was skeptical my deck could be saved — it was black with mould and algae. DuraWash came out the next day and restored it to almost new. The price was fair and the job was done in under 3 hours. Incredible.",
    initials: "JK",
    color: "bg-brand-dark",
  },
  {
